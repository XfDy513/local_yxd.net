...
return
    ...
    array(
        ...
        '添加商品'=>'/index.php?case=table&act=add&table=archive&shopping=1&admin_dir='.get('admin_dir',true).'&site=default',
        '商品添加'=>'/index.php?case=table&act=add&table=archive&shopping=1&admin_dir='.get('admin_dir',true).'&site=default',
        '添加内容栏目'=>'/index.php?case=table&act=add&table=category&admin_dir='.get('admin_dir',true).'&site=default',
        '添加商品栏目'=>'/index.php?case=table&act=add&table=category&shopping=1&admin_dir='.get('admin_dir',true).'&site=default',
        '添加分类'=>'/index.php?case=table&act=add&table=type&admin_dir='.get('admin_dir',true).'&site=default',
        '添加专题'=>'/index.php?case=table&act=add&table=special&admin_dir='.get('admin_dir',true).'&site=default',
        ...
        '商品管理'=>'/index.php?case=table&act=list&table=archive&shopping=1&admin_dir='.get('admin_dir',true).'&site=default',
        '管理商品'=>'/index.php?case=table&act=list&table=archive&shopping=1&admin_dir='.get('admin_dir',true).'&site=default',
        ...
        '分类管理'=>'/index.php?case=table&act=list&table=type&admin_dir='.get('admin_dir',true).'&site=default',
        '管理分类'=>'/index.php?case=table&act=list&table=type&admin_dir='.get('admin_dir',true).'&site=default',
        '专题管理'=>'/index.php?case=table&act=list&table=special&admin_dir='.get('admin_dir',true).'&site=default',
        '管理专题'=>'/index.php?case=table&act=list&table=special&admin_dir='.get('admin_dir',true).'&site=default',
        ...
        '订单'=>'/index.php?case=table&act=list&table=orders&admin_dir='.get('admin_dir',true).'&site=default',
        '管理订单'=>'/index.php?case=table&act=list&table=orders&admin_dir='.get('admin_dir',true).'&site=default',
        '订单管理'=>'/index.php?case=table&act=list&table=orders&admin_dir='.get('admin_dir',true).'&site=default',
        '快递'=>'/index.php?case=express&act=index&admin_dir='.get('admin_dir',true).'&site=default',
        '蜘蛛'=>'/index.php?case=stats&act=list&table=stats&admin_dir='.get('admin_dir',true).'&site=default',
        '内链'=>'/index.php?case=table&act=list&table=linkword&admin_dir='.get('admin_dir',true).'&site=default',
        ...
        '推广模块'=>'/index.php?case=union&act=config&table=union&admin_dir='.get('admin_dir',true).'&site=default',
        '优惠券'=>'/index.php?case=table&act=list&table=coupon&admin_dir='.get('admin_dir',true).'&site=default',
        '充值记录'=>'/index.php?case=table&act=list&table=consumption&=&admin_dir='.get('admin_dir',true).'&site=default',
        ...
        '登录API'=>'/index.php?case=ologin&act=list&table=ologin&admin_dir='.get('admin_dir',true).'&site=default',
      ...
      '内容排序'=>'/index.php?case=table&act=list&table=archive&admin_dir='.get('admin_dir',true).'&site=default',
        ...
        '复制商品'=>'/index.php?case=table&act=list&table=archive&shopping=1&admin_dir='.get('admin_dir',true).'&site=default',
        ...
        '编辑分类'=>'/index.php?case=table&act=list&table=type&admin_dir='.get('admin_dir',true).'&site=default',
        '编辑专题'=>'/index.php?case=table&act=list&table=special&admin_dir='.get('admin_dir',true).'&site=default',
        '配货设置'=>'/index.php?case=logistics&act=list&table=logistics&admin_dir='.get('admin_dir',true).'&site=default',
        '订单设置'=>'/index.php?case=config&act=system&set=orders&admin_dir='.get('admin_dir',true).'&site=default',
        '批量打印'=>'/index.php?case=table&act=list&table=orders&admin_dir='.get('admin_dir',true).'&site=default',
        '新增订单'=>'/index.php?case=table&act=add&table=orders&admin_dir='.get('admin_dir',true).'&site=default',
        '快递设置'=>'/index.php?case=express&act=config&table=expressconfig&admin_dir='.get('admin_dir',true).'&site=default',
        '添加内链'=>'/index.php?case=table&act=add&table=linkword&admin_dir='.get('admin_dir',true).'&site=default',
        ...
        '添加优惠券'=>'/index.php?case=table&act=add&table=coupon&admin_dir='.get('admin_dir',true).'&site=default',
        '公告'=>'/index.php?case=table&act=list&table=announcement&admin_dir='.get('admin_dir',true).'&site=default',
        '留言'=>'/index.php?case=table&act=list&table=guestbook&admin_dir='.get('admin_dir',true).'&site=default',
        '留言字段设置'=>'/index.php?case=table&act=list&table=guestbookfield&admin_dir='.get('admin_dir',true).'&site=default',
        '评论'=>'/index.php?case=table&act=list&table=comment&admin_dir='.get('admin_dir',true).'&site=default',
        '投票'=>'/index.php?case=table&act=list&table=ballot&admin_dir='.get('admin_dir',true).'&site=default',
        '表单'=>'/index.php?case=form&act=listform&admin_dir='.get('admin_dir',true).'&site=default',
        ...
        '水印'=>'/index.php?case=config&act=system&set=image&admin_dir='.get('admin_dir',true).'&site=default',
        '附件'=>'/index.php?case=config&act=system&set=upload&admin_dir='.get('admin_dir',true).'&site=default',
        '短信'=>'/index.php?case=config&act=system&set=sms&admin_dir='.get('admin_dir',true).'&site=default',
        ...
        '多点登录'=>'/index.php?case=website&act=listwebsite&admin_dir='.get('admin_dir',true).'&site=default',
        '支付'=>'/index.php?case=pay&act=list&table=pay&admin_dir='.get('admin_dir',true).'&site=default',
		'seo'=>'/index.php?case=table&act=list&table=linkword&admin_dir='.get('admin_dir',true).'&site=default',
		'优化'=>'',
		'营销'=>'',
