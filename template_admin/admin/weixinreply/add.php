...
<h5>{lang_admin('add_wechat_public_number_response')}</h5>
...
<input type="hidden" name="pid" id="pid" value="<?php echo intval(front::get('pid'));?>" />
  <div id="tagscontent" class="right_box">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table1">
      ...
      <tr class="s_out" >
        <td width="19%" align="right">{lang_admin('mold')}</td>
        <td width="1%">&nbsp;</td>
		...
		<dl>
			...
			<dd>
				<textarea name="txt" class="textarea gens nonull" value="{lang_admin('please_fill_in_the_reply')}" placeholder="{lang_admin('please_fill_in_the_reply')}" ></textarea><span class="hotspot" onmouseover="tooltip.show('{lang_admin('wechat_can_identify_the_phone_number_and_support_direct_dialing_by_clicking_on_the_phone_number')}');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
			</dd>
		</dl>
		</div>
