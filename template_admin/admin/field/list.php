...
<div class="main-right-box">
    ...
    <div class="box" id="box">
        ...
        <a href="#" onclick="gotourl(this)" data-dataurl="{$base_url}/index.php?case=field&act=add&table=archive&admin_dir={get('admin_dir',true)}&site=default" class="btn btn-primary<?php
        $listform = $_GET['table'];
        if($listform=='archive'){
            echo " show";
        }else{
        ...
        ?>" data-dataurlname="{lang_admin('adding_content_fields')}">{lang_admin('adding_content_fields')}</a>
            ...
            <a href="#" onclick="gotourl(this)" data-dataurl="{$base_url}/index.php?case=field&act=add&table=user&admin_dir={get('admin_dir',true)}&site=default" class="btn btn-primary<?php
            $listform = $_GET['table'];
            if($listform=='user'){
                echo " show";
            }else{
            ...
            <a href="#" onclick="gotourl(this)"   data-dataurl="{$base_url}/index.php?case=field&act=add&table=category&admin_dir={get('admin_dir',true)}&site=default" class="btn btn-primary<?php
            $listform = $_GET['table'];
            if($listform=='category'){
                echo " show";
            }else{
            ...
            <a href="#" onclick="gotourl(this)"   data-dataurl="{$base_url}/index.php?case=field&act=add&table={$table}&admin_dir={get('admin_dir',true)}&site=default" class="btn btn-primary<?php
            $listform = $_GET['table'];
        ...
        <form name="listform" id="listform"  action="<?php echo uri();?>" method="post">
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <?php if($f['name'] != 'my_field'){ ?>
                        <tr>
                            ...
                            <td  class="htmldir"><?php $newcname='cname_'.lang::getisadmin();echo @setting::$var[$table][$f['name']][$newcname];?></td>
                            <td class="manage">
                ...
                <input class="btn btn-gray" type="button" value=" {lang_admin('sort')} " name="order" onclick="this.form.action='<?php echo modify('act/batch',true);?>'; this.form.batch.value='listorder'; returnform(this.form);"/>
