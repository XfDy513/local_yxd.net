...
<div class="main-right-box">
    <h5><?php echo lang_admin('custom_fields');?></h5>
    <div class="blank20"></div>
    <div class="box" id="box">
        <input type="button" name="Submit" value="<?php echo lang_admin('return_list');?>" class="btn btn-secondary" onclick="gotourl(this)"   data-dataurl="<?php echo url('field/list/table/'.front::get('table'));?>">
        ...
        <form method="post" action="<?php echo uri();?>" name="form1" id="form1" onsubmit="return returnform(this)">
                ...
                <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
                    ...
                    if(is_array($langdata)){
                        foreach ($langdata as $key=>$value){
                            ...
                            ?>
                            <input class="form-control" name=" <?php echo $newcname;?>" id=" <?php echo $newcname;?>" value="<?php echo $data[$newcname];?>" placeholder="<?php echo $value['langname'];?>"  onblur="form_preview()"/>
                        <?php    }
                    }
                    ?>
                    <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="<?php echo lang_admin('must_fill_in');?>"></span>
            ...
            if($table == 'archive') {
                ...
                ?>
                    <div class="row" id="catidshow">
                        ...
                        <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
                            <input type="hidden" id="catid_val_<?php echo $value['langurlname'];?>" value="<?php echo $data[$newcatid];?>">
            ...
            <div  class="varchar2" >
                <div class="row" id="typeshow">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
                        <select name="type" id="type" onchange="checktoselect(); form_preview();" class="form-control select">
                            ...
                            <option value="_image" <?php echo @setting::$var[$table][$field['name']]['filetype']=='image'?'selected':''?>><?php echo lang_admin('picture');?></option>
                ...
                <div class="row"  id="lengshow">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
                        <input class="form-control" name="len" id="len" value="<?php echo $field['len'];?>" onblur="form_preview()" oninput="value=value.replace(/[^\d]/g,'')"/>
