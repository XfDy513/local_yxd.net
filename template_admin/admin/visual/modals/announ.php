<div class="modal fade" id="template-announ-tag" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                    {lang_admin('announcement_attributes')}
                </h4>
            </div>
            <div class="modal-body">
                <form method="post" name="frmAnnoun" id="frmAnnoun" action="">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-5 col-md-4 col-lg-3 text-right">
                            {lang_admin('number_of_list_items')}
                        </div>
                        <div class="col-xs-6 col-sm-7 col-md-7 col-lg-8 text-left">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-5 col-md-4 col-lg-3 text-right">
                            {lang_admin('whether_to_display_time_or_not')}
                        </div>
                        <div class="col-xs-6 col-sm-7 col-md-7 col-lg-8 text-left">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-7 col-md-7 col-lg-8 text-left">
                            ...
                            <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right"
                                  title=""
                                  title="{lang_admin('label_template_files_are_stored_in_current_background_template directory')}">
                                    </span>
                        </div>
                    </div>
                    <div class="clearfix blank20">
