        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                    {lang_admin('contact_information')}
                </h4>
            </div>
            <div class="modal-body">
                <form method="post" name="frmTel" id="frmTel" action="">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-5 col-md-4 col-lg-3 text-right">
						{lang_admin('fill_in_the_menu_and_click_on_the_jump_address_in_http_address')}
                        </div>
                        <div class="col-xs-6 col-sm-7 col-md-7 col-lg-8 text-left">
            ...
            <div class="modal-footer">
                ...
                <button id="saveTelStyle" type="button" class="btn btn-primary" data-dismiss="modal">{lang_admin('preservation')}
                </button>
            </div>
        </div>
    </div>
