    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <input id="text_1" placeholder="{lang_admin('connection_text_1')}" name="text_1" type="text" class="form-control">
                    <input id="img_1" name="img_1" type="hidden" class="form-control">
                </div>
                <div class="form-group">
                    <input id="url_1" placeholder="{lang_admin('connection_address')}1" name="url_1" type="text" class="form-control">
                </div>
                ...
                <div class="form-group">
                    <input id="text_2" placeholder="{lang_admin('connection_text_2')}" name="text_2" type="text" class="form-control">
                    <input id="img_2" name="img_2" type="hidden" class="form-control">
                </div>
                <div class="form-group">
                    <input id="url_2" name="url_2" placeholder="{lang_admin('connection_address')}2" type="text" class="form-control">
                </div>
                ...
                <div class="form-group">
                    <input id="text_3" name="text_3" placeholder="{lang_admin('connection_text_3')}" type="text" class="form-control">
                    <input id="img_3" name="img_3" type="hidden" class="form-control">
                </div>
                <div class="form-group">
                    <input id="url_3" name="url_3" placeholder="{lang_admin('connection_address')}3" type="text" class="form-control">
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button id="btn_savePictures" type="button" data-dismiss="modal" class="btn btn-primary">{lang_admin('preservation')}
                </button>
            </div>
        </div>
