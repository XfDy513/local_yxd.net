...
<div class="lyrow visual-drag-box box-element">
	...
	<div class="preview">
		...
		<p>{lang_admin('special_pictures')}</p>
	</div>
	<div class="view">
		<div class="special-picture">
			<div class="codearea">
				<center><img src="#[#$special['banner']#]#" class="img-responsive"></center>
			</div>
			<div class="viewarea">
				<center><img src="{$base_url}/common/plugins/visual/images/modules/special.jpg" class="img-responsive"></center>
			</div>
		</div>
	</div>
</div>
