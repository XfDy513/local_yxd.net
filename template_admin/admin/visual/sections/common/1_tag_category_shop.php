...
<div class="lyrow visual-drag-box box-element">
    <span class="drag label btn-group drag-container">
        ...
        <ul class="dropdown-menu btn-black-dropdown-menu">
			...
			<li><a title="{lang_admin('set_up')}" data-target="#template-category-shop-tag" role="button"  data-toggle="modal"><i class="glyphicon glyphicon-pencil"></i>{lang_admin('set_up')}</a></li>
            <li><a title="{lang_admin('delete')}" class="remove"><i class="glyphicon glyphicon-remove"></i>{lang_admin('delete')}</a></li>
        </ul>
    </span>
    <div class="preview">
        <img src="{$base_url}/common/plugins/visual/images/section/tag_category.png">
        <p>{lang_admin('shopping_column_lable')}</p>
    </div>
    <div class="view">
