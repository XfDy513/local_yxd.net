...
<div class="visual-drag-box box-element visual-inline-block">
    <span class="drag label btn-group drag-container">
        ...
        <ul class="dropdown-menu btn-black-dropdown-menu">
            ...
            <li><a title="{lang_admin('setting_icons')}" data-target="#icon-config" role="button" data-toggle="modal"><i class="glyphicon glyphicon-pencil"></i>{lang_admin('set_up')}</a></li>
	...
	<div class="preview">
		<img src="{$base_url}/common/plugins/visual/images/section/icon.png">
		<p>{lang_admin('icon')}</p>
	</div>
	<div class="view">
		<div class="visual-inline-block visual-ico">
