        ...
        <form method="post" name="form1" action="<?php if(front::$act=='edit') $id="/id/".$data[$primary_key]; else $id=''; echo modify("/act/".front::$act."/table/".$table.$id);?>"
            ...
            <div id="single" style="display:block;">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
                        ...
                        <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="{lang_admin('fill_in_the_sub_nam_level_type_can_be_skipped')}">
    </span>
                    </div>
                </div>
                <div class="clearfix blank20"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
                        ...
                        <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="{lang_admin('catalogues_must_be_english_names_if_left_blank_the_pinyin_names_will_be_used_automatically_do_not_mix_symbols')}">
    </span>
                    </div>
                </div>
                <div class="clearfix blank20"></div>
            ...
            <div id="batch" style="display:none;">
                <div class="row">
                    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 text-right"><span class="icon-note"></span>&nbsp;{lang_admin('name')}</div>
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
                        <textarea name="batch_add" maxlength="255" class="form-control textarea" placeholder="{lang_admin('for_example_type_1_type_2')}"></textarea>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane" id="tag5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
                            ...
                            <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="{lang_admin('after_filling_out_the_external_link_address_the_access_type_will_jump_to_the_completed_address')}" onmouseout="tooltip.hide();">
