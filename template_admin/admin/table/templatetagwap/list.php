...
<div class="main-right-box">
    <h5>{lang_admin('mobile_template_tag_list')}</h5>
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            ?>">
                ...
                <ul class="dropdown-menu" aria-labelledby="tag1" id="tag1-contents">
                    <li>
                        <a href="#" onclick="gotourl(this)"   data-dataurl="{$base_url}/index.php?case=table&act=list&table=templatetag&tagfrom=content&admin_dir={get('admin_dir',true)}&site=default" data-dataurlname="{lang_admin('wap_column_lable')}">{lang_admin('wap_column_lable')}</a>
                    </li>
                    <li>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr class="th">
                                ...
                                <th class="htmldir">{lang_admin('format')}</th>
                                <th class="htmldir"><!--tagcontent-->{lang_admin('template')}</th>
                                    ...
                                    if(($_GET['tagfrom']!='function')){
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="#" onclick="gotourl(this)"   data-dataurl='<?php echo url("templatetagwap/test/id/$d[$primary_key]",false);?>' target="_blank" title="{lang_admin('see')}">{lang_admin('see')}</a>
                                                </li>
                                                <li>
