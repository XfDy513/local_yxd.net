...
<h5>{lang_admin('content_list')}</h5>
<div class="blank20"></div>
<div class="box" id="box">
<div class="archive-list">

 <form name="searchform" id="searchform"  action="<?php echo uri();?>" method="post" class="form-inline" onsubmit="return returnform(this);" >
			{lang_admin('user')}&nbsp;
			
    <input type="text" class="form-control" name="search_username" id="search_username" value="" />
            {lang_admin('date')}&nbsp;
...
<tbody>
            ...
            <tr>
                ...
                <td class="manage">
                    ...
                    <?php
                    if($d['status']==0){ ?>
                        <a class="btn btn-default" href='<?php echo url("archive/payconsumption/oid/".$d['oid'],false);?>' target="_blank" class="btn btn-default">{lang_admin('immediate_payment')}</a>
                    <?php };?>  </td>
            </tr>
            {/loop}
