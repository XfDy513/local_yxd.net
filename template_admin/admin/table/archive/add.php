                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-9 col-lg-5 text-left">
                            <div id="uploadarea">
                                ...
                                <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="<?php echo lang_admin('when_the_content_page_template_is_selected_picture_content_page_archive_show_pic_html_is_used_for_picture_slide_display_effect_display');?>"></span>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix blank20"></div>
