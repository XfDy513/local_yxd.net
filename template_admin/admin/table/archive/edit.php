...
<div class="main-right-box">
    <div class="box edit-content">
        ...
        ?>" enctype="multipart/form-data" onsubmit="return checkform(this);">
            ...
            <input type="hidden" id="aid" value="{$data['aid']}"/>
...
//if(preg_match('/^pics([\d]+)$/',$k,$out) && $v){
                                ...
                                <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="<?php echo lang_admin('when_the_content_page_template_is_selected');?><br /> [ <?php echo lang_admin('picture_content_page');?> - archive/show_pic.html ] <br /><?php echo lang_admin('used_for_picture_slide_display_effect_display');?>"></span>
                            </div>
                ...
                <?php if($shopping){?>
                    ...
                    <div role="tabpanel" class="tab-pane" id="tag9">
                        ...
                        <?php if( (setting::$var['archive'][$name]['isshoping'] == '1')){?>
