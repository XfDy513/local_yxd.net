                ...
                <div role="tabpanel" class="tab-pane" id="tag2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
                            ...
                            <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="{lang_admin('select_whether_the_topic_generates_html_static_pages')}"></span>
                ...
                <div role="tabpanel" class="tab-pane" id="tag3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
                            ...
                            <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="{lang_admin('banner_function_need_to_call_display_in_the_template')}"></span>
