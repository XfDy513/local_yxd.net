        ...
        <form method="post" name="form1" action="<?php if(front::$act=='edit') $id="/id/".$data[$primary_key]; else $id=''; echo modify("/act/".front::$act."/table/".$table.$id);?>"
            ...
            <?php if($shopping){
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('catidshopping',$form,$field,$data)}<span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="{lang_admin('if_its_a_first_level_column_you_dont_need_to_choose_it')}"></span>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
                    <input type="text" class="form-control"  value="{$data['catname']}" name="catname" id="catname" />
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="tag2">
                    ...
                    <div class="row">
                        <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 text-right"><span class="icon-note"></span>&nbsp;{lang_admin('page_description')}
                        </div>
                        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
