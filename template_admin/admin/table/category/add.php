 ...
 <a id="content-eidt-nav-btn" class="btn btn-default" style="display:none;">
            ...
            <div id="single" style="display:block;">
                <div class="row">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('catidshopping',$form,$field,$data)}
                        <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="{lang_admin('if_its_a_first_level_column_you_dont_need_to_choose_it')}"></span>
                    </div>
                </div>
                ...
                <div id="batch" style="display:none;">
                    <div class="row">
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-9 col-lg-10 text-left">
                            <textarea name="batch_add" placeholder="{lang_admin('for_example_type_1_type_2')}" maxlength="255" class="form-control textarea"></textarea>
                        </div>
                    </div>
                    <div class="clearfix blank20"></div>
                </div>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="tag2">
                        ...
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 text-right">{lang_admin('content_url')}</div>
                            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
...
<!--
                    ...
                    <div role="tabpanel" class="tab-pane" id="tag5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
                                {form::getform('isblank',$form,$field,$data)}  <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="{lang_admin('is_it_open_in_the_new_window')}"></span>
                        ...
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 text-right">{lang_admin('does_the_content_page_bind_the_form')}</div>
                            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
