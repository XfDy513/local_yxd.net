<div class="main-right-box">
    <h5>{lang_admin('user_group_list')}</h5>
    <div class="blank20"></div>
    <div class="box" id="box">
        <a href="#" onclick="gotourl(this)"   data-dataurl="{$base_url}/index.php?case=table&act=add&table=usergroup&admin_dir={get('admin_dir',true)}&site=default" class="btn btn-primary" data-dataurlname="{lang_admin('adding_user_groups')}">{lang_admin('adding_user_groups')}</a>
