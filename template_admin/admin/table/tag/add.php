...
<div class="main-right-box">
    ...
    <div class="box" id="box">
        ...
        <form method="post" name="form1" action="<?php if(front::$act=='edit') $id="/id/".$data[$primary_key]; else $id=''; echo modify("/act/".front::$act."/table/".$table.$id);?>"
            ...
            <input class="btn btn-secondary" type="button" value=" {lang_admin('return_list')} "
                   onclick="gotourl(this)"   data-dataurl="index.php?case=table&act=list&table=tag&admin_dir={get('admin_dir',true)}" />
           ...
           <!-- <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-4 text-left">
                    {form::getform('ranges',$form,$field,$data)}
