...
<div class="box" id="box">
    ...
    <input class="btn btn-primary" type="button" value=" {lang_admin('comment_manage_settings')} " onclick="gotourl(this)"   data-dataurl="{url::create('config/system/set/discuss')}" data-dataurlname="{lang_admin('comment_manage_settings')}" />
