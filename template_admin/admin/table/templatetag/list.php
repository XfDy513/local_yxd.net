...
<div class="main-right-box">
	<h5>{lang_admin('template_label_list')}</h5>
	<div class="blank20">
	</div>
						...
						<td class="htmldir" align="left">
							...
							<tr>
								<td>
                                    ...
                                    {else}
                                    <span>{</span>tag_{cut($d['name'])}<span>}</span>
                                    {/if}
								</td>
							</tr>
							<tr>
								<td>
                                    ...
                                    {if $d['tagfrom']=='shopcategory' || $d['tagfrom']=='shopspecial'|| $d['tagfrom']=='shoptype' ||  $d['tagfrom']=='shopcontent'}
                                    <a href="javascript:;"><span style="color:green;">{lang_admin('display_jsdisplay_js')}</span></a><span style="display:none;margin-top:10px;">&lt;script src="{get('site_url')}index.php?case=templatetag&act=get&id={cut($d['id'])}&shopping=1&="&gt;&lt;/script&gt;</span>
                                    {else}
                                    <a href="javascript:;"><span style="color:green;">{lang_admin('display_js')}</span></a><span style="display:none;margin-top:10px;">&lt;script src="{get('site_url')}index.php?case=templatetag&act=get&id={cut($d['id'])}&="&gt;&lt;/script&gt;</span>
                                    {/if}
								</td>
							</tr>
							</table>
