...
if($tag_config['tyname']) $tyname_checked = 'checked';
if($tag_config['subtitle']) $subtitle_checked = 'checked';
if($tag_config['tyimage']) $tyimage_checked = 'checked';
if($tag_config['tycontent']) $tycontent_checked = 'checked';
?>
...
<div class="row">
    ...
    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
        ...
        <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="{lang_admin('whether_to_call_the_classified_picture')}"></span>
    </div>
</div>
<div class="clearfix blank20"></div>
<div class="row">
