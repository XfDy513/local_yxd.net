...
<input type="hidden" name="batch" value="">
   ...
   <input  class="btn btn-warning" type="button" value=" {lang_admin('delete')} " name="delete" onclick="deleteLogTxt()"/>

<input  class="btn btn-danger" type="button" value=" {lang_admin('all_emptied')} " name="delete" onclick="alldeleteLog()"/>
