    ...
    .list-group-item { min-height:144px; margin:0px 10px 10px 10px; padding:25px 30px 20px 30px; -moz-box-shadow:0px 8px 15px #eee;
        ...
        <form method="post" action="<?php echo uri();?>" name="config_form" id="config_form">
            ...
            <div class="quick-navb">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4  quick-navb-item">
                    <div class="row">
                        <a href="#" onclick="gotourl(this)"   data-dataurl="{$base_url}/index.php?case=config&act=system&set=slide&admin_dir={get('admin_dir',true)}&site=default" class="list-group-item" data-dataurlname="{lang_admin('slide')}"><span class="icon-film"></span> 	<p><strong>{lang_admin('slide')}</strong></p>{lang_admin('slide_expansion_info')}</a></a>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4  quick-navb-item">
                    <div class="row">
                        <a title="" href="#" onclick="gotourl(this)"   data-dataurl="{$base_url}/index.php?case=config&act=system&set=image&admin_dir={get('admin_dir',true)}&site=default" class="list-group-item" data-dataurlname="{lang_admin('watermarking_settings')}"><span class="icon-picture"></span> 	<p><strong>{lang_admin('watermarking_settings')}</strong>{lang_admin('setting_upload_picture_to_increase_watermark_logo')}</p></a>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4  quick-navb-item">
                    <div class="row">
                        <a title="" href="#" onclick="gotourl(this)"   data-dataurl="{$base_url}/index.php?case=config&act=system&set=sms&admin_dir={get('admin_dir',true)}&site=default" class="list-group-item" data-dataurlname="{lang_admin('short_message_settings')}"><span class="icon-bubbles"></span> 	<p><strong>{lang_admin('short_message_settings')}</strong>{lang_admin('short_message_service_for_opening_mobile_message_notification_and_mobile_verification_code')}</p></a>
                    </div>
                </div>
