...
<div class="main-right-box">
    <h5>{lang_admin('mobile_home_page_generation')}</h5>
...
<div class="alert alert-danger" role="alert">
    ...
    <strong><?php echo lang_admin('tips');?>！</strong>
    {lang_admin('not_wap_set_up')}， <a title="" href="#" onclick="gotourl(this)"   data-dataurl="{$base_url}/index.php?case=config&act=system&set=phonesite&admin_dir={get('admin_dir',true)}&site=default" data-dataurlname="{lang_admin('mobile_version')}" class="btn btn-info">{lang_admin('go_set_up')}</a>
</div>
    </div>
    </div>
<?php } ?>
