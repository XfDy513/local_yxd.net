...
<script type="text/javascript" language="JavaScript">
	...
	function saveResponse(options){
		var inputstr='<td class="trtitle02" id="upfilepath"><input type="text" name="upfilepath" maxlength="200" size="50" class="infoInput"> "{lang_admin('must_start_with_http')}"</td>';
