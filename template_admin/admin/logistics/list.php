...
<a onclick="if(confirm('{lang_admin('are_you_sure_you_want_to_delete_it')}')){gotourl(this);};" href="#"    data-dataurl="<?php echo modify("/act/delete/table/$table/id/".$d['id']);?>" title="{lang_admin('delete')}"><i class="glyphicon glyphicon-trash"></i></a>
</td>
</tr>
{/loop}
