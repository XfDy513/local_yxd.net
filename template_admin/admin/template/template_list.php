    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4  quick-navb-item">
        <div class="list-group-item">
            ...
            <div class="template_btn">
                ...
                <div class="col-md-6">
                    <div class="row">
                        <a href="<?php echo url('template/del/tplname/'.$val,1);?>" onClick="return confirm('{lang_admin('are_you_sure_you_want_to_delete_it')}')"><i class="glyphicon glyphicon-trash"></i> 删除</a>
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
