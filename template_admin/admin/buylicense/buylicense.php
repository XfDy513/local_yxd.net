    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btn_buy" class="btn btn-primary"><?php echo lang_admin('buy');?></button>
...
<div class="main-right-box">
    ...
    <div class="box" id="box">
        ...
        <h5>
            <?php echo lang_admin('commercial_authorization');?>
            ...
            <a class="btn btn-primary"  href="#" onclick="gotourl(this)"   data-dataurl="<?php echo url('app/close/buytemplate/1',true);?>" ><?php echo lang_admin('sign_out');?></a>
                ...
                <a href="#" onclick="gotourl(this)"   data-dataurl="<?php echo $base_url;?>/index.php?case=license&act=licenselist&admin_dir=<?php echo get('admin_dir',true);?>&site=default" data-dataurlname="<?php echo lang_admin('license_list');?>" class="btn btn-default"><?php echo lang_admin('license_list');?></a>
            <?php } else { ?>
            ...
            <div class="system_down text-center">
                ...
                <div class="shop-price">
                    <a  title="<?php echo lang_admin('purchase_authorization') ;?>" class="btn btn-license" data-toggle="modal"
                        ...
                        <?php echo lang_admin('purchase_authorization') ;?> <?php echo lang('unit');?><span id="shop-price">
                                <?php  echo floatval($data['attr2'])*($returndata['userdata']['discount']>0?$returndata['userdata']['discount']:10)/10; ?></span></a>
                </div>
                <div class="blank30"></div>
                <div class="clearfix"></div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.static == 1) {
                        ...
                        $(".modal-backdrop.fade").hide();
                        gotoinurl("/index.php?case=license&act=buylicense&admin_dir=<?php echo get('admin_dir');?>");
                    } else {
                        alert(data.message);
                    }
                }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.static){
                        ...
                        gotoinurl("/index.php?case=license&act=licenselist&admin_dir=<?php echo get('admin_dir');?>");
                    }else{
                        alert(data.message);
                        console.log(data);
                    }
...
<script src="<?php echo $base_url;?>/common/js/shopping.js"></script>
...
//组合商品
        var combined='<?php echo $archive["combined"];?>';
        var unit="<?php echo lang('unit');?>";
        var priceurl='<?php echo url("archive/getarchiveprice");?>';
