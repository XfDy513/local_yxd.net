...
<h5>{lang_admin('add_third_party_login')}<a href="#" onclick="gotourl(this)" data-dataurl="<?php echo url('ologin/list/table/ologin');?>" class="btn btn-secondary pull-right" >{lang_admin('return')}</a>
</h5>
