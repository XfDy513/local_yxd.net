...
<th>{lang_admin('id')}</th>
      ...
      <tr class="s_out" onmouseover="m_over(this)" onmouseout="m_out(this)" lang="0">
        ...
        <td class="manage">
<a  href="#" onclick="gotourl(this)" data-dataurl="<?php echo url('weixinmenu/edit/id/'.$d['id']);?>" title="{lang_admin('edit')}"><i class="glyphicon glyphicon-edit"></i></a>
<a onclick="if(confirm('{lang_admin('are_you_sure_you_want_to_delete_it')}')){gotourl(this);};" href="#"   data-dataurl="<?php echo url('weixinmenu/del/wid/'.intval(front::$get['id']).'/id/'.$d['id']);?>" title="{lang_admin('delete')}"><i class="glyphicon glyphicon-trash"></i></a>
<a href="#" onclick="gotourl(this)"   data-dataurl="<?php echo url('weixinmenu/add/wid/'.intval(front::$get['id']).'/pid/'.$d['id']);?>" title="{lang_admin('submenu')}"><i class="glyphicon glyphicon-list-alt"></i></a>
		</td>
      </tr>
      <?php
...
<a onclick="if(confirm('{lang_admin('are_you_sure_you_want_to_delete_it')}')){gotourl(this);};" href="#"  data-dataurl="<?php echo url('weixinmenu/del/wid/'.intval(front::$get['id']).'/id/'.$submenu['id']);?>" title="{lang_admin('delete')}"><i class="glyphicon glyphicon-trash"></i></a>
		</td>
      </tr>
      <?php
		  }
...
<input type="button" name="button" id="button" value=" {lang_admin('add_a_level_1_menu')} " onclick="gotourl(this)"   data-dataurl="<?php echo url('weixinmenu/add/wid/'.front::get('id').'/pid/0');?>;" class="btn btn-success" />
