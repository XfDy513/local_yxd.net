...
<div class="main-right-box">
    <h5>{lang_admin('picture_list')}</h5>
    <div class="blank20"></div>
    <div class="box" id="box">

        <div class="padding10">
            <input type="button" name="button1" class="btn btn-secondary" value="{lang_admin('return')}"   onclick="gotourl(this)"   data-dataurl={$base_url}/index.php?case=image&act=listdir&admin_dir={get('admin_dir',true)}&site=default">
