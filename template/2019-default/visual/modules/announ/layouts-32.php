...
<div class="lyrow position-move visual-drag-box box-element clearfix">
    ...
    <div class="preview">
        <img src="{$skin_path}/images/visual/modules/layouts-13.jpg" alt="公告标题">
        <p>公告标题</p>
    </div>
    <div class="view">
        <div class="codearea">
            <div class="list-title list-title2">
                <div class="container">
                    <div class="row">
                        <p class="column-htmldir">Announ</p>
                        <h4 class="column-title">#[#$announ['title']#]#</h4>
                    </div>
                </div>
            </div>
        </div>
