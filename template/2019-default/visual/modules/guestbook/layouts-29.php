...
<div class="lyrow position-move visual-drag-box box-element clearfix">
    ...
    <div class="preview">
		<img src="{$skin_path}/images/visual/modules/layouts-13.jpg" alt="留言标题">
		<p>留言标题</p>
    </div>
	<div class="view">
        <div class="codearea">
			<div class="list-title list-title2">
				<div class="container">
                    <p class="column-htmldir">Guestbook</p>
					<h4 class="column-title">#[#lang('guestbook')#]#</h4>
				</div>
			</div>
        </div>
        <div class="viewarea">
