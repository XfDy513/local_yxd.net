...
class website_admin extends admin {
    ...
    function addwebsite_action() {
        ...
        if (front::post('submit')) {
            ...
            front::redirect(url('website/listwebsite',true));
        }
    }
            ...
            if(!($file == '..')) {
                if(!($file == '.')) {
                    if(!is_dir($path.'/'.$file)) {
                        ...
                        $tmparr['website']['site_websiteimg'] = $tmparr['site_websiteimg'];
    ...
    function checkmysql_action() {
        ...
        if($mysqlconn) {
            echo '<font color="green">'.lang_admin('connected_database_server_success').'！</font>';
        }else {
            echo '<font color="red">'.lang_admin('connected_database_server_failure').'！</font>';
        }
        exit;
    }
    function checkftp_action() {
        ...
        if(!$ftperror) {
            echo '<font color="green">'.lang_admin('connected_FTP_server_success').'！</font>';
        }else {
